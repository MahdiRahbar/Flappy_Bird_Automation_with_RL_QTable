/* 	flappy bird clone for school research thingie
	This Java Script file is mostly written by Gilles Coremans 
	It also can be found in the following link
	https://jsfiddle.net/83cgLwy7/1/
	...
	if(pipes.length < 3 && pipeDelay === 0)
	{
		...
		pipes[pipes.length] = 
					{		x 			: 	canvas.width + pipeWidth,
							width 		: 	pipeWidth,
							gapStart 	:	200,   // Changing the gap size to make the learning process more simple
												   // GapStart   :   randomBetween(100, canvas.height - 100),
							gapSize		:	150,   // We did the same for gapSize
